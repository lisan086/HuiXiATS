...
namespace YiBanSaoMaQi.Frm
{
    public partial class SheBeiKJ : UserControl
    {
        ...
        public SaoMaModel GetSaoMaModel() 
        {
            ...
            model.ZhiLing1=this.textBox2.Text;
            model.ZhiLing2 =this.textBox3.Text;
