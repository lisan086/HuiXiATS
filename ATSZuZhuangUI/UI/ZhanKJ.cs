...
{
    public partial class ZhanKJ : UserControl, IFTongYongKJ
    {
        Image OK = null;
        Image NG = null;
        private int TDID = -1;
        ...
        public void SetCanShu(EventType arg1, JieMianShiJianModel model)
        {
            ...
            switch (arg1)
            {
                case EventType.ZhanKaiShiJinZhan:
                    {
                        this.pictureBox1.Visible = false;
                    ...
                    break;
                case EventType.ZhanJinZhanJieGuo:
                    {
                        this.label4.Text = model.MiaoSu;
                    ...
                    break;
                case EventType.ZhanKaiShiChuZhan:
                    {
                        this.label1.Text = ChangYong.TryStr(model.ErWeiMa, "");
                        this.label4.Text = model.MiaoSu;
                    }
                    break;
                case EventType.ZhanChuZhanData:
                    {
                    ...
                    break;
                case EventType.ZhanChuZhanJieGuo:
                    {
